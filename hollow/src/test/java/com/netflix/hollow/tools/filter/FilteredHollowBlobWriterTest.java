...
public class FilteredHollowBlobWriterTest {
    ...
    public void filtersDataFromBlob() throws IOException {
        ...
        assertEquals(2, readEngine.getSchemas().size());
        assertEquals(1, ((HollowObjectSchema)readEngine.getSchema("TypeA")).numFields());
        assertEquals(2, ((HollowObjectSchema)readEngine.getSchema("TypeB")).numFields());
        
        assertEquals(3, readEngine.getTypeState("TypeA").getPopulatedOrdinals().cardinality());
        assertEquals(1, new GenericHollowObject(readEngine, "TypeA", 0).getInt("id"));
        assertEquals(2, new GenericHollowObject(readEngine, "TypeA", 1).getInt("id"));
        assertEquals(3, new GenericHollowObject(readEngine, "TypeA", 3).getInt("id"));
        
        assertEquals(3, readEngine.getTypeState("TypeB").getPopulatedOrdinals().cardinality());
        assertEquals(1, new GenericHollowObject(readEngine, "TypeB", 0).getInt("id"));
        assertEquals(1.1f, new GenericHollowObject(readEngine, "TypeB", 0).getFloat("value"), 0);
        assertEquals(2, new GenericHollowObject(readEngine, "TypeB", 1).getInt("id"));
        assertEquals(2.2f, new GenericHollowObject(readEngine, "TypeB", 1).getFloat("value"), 0);
        assertEquals(3, new GenericHollowObject(readEngine, "TypeB", 3).getInt("id"));
        assertEquals(4.4f, new GenericHollowObject(readEngine, "TypeB", 3).getFloat("value"), 0);
        ...
        assertEquals(2, readEngine.getTypeState("TypeA").getPopulatedOrdinals().cardinality());
        assertEquals(2, readEngine.getTypeState("TypeB").getPopulatedOrdinals().cardinality());
    }

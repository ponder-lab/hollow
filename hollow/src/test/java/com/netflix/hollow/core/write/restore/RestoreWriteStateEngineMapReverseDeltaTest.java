...
public class RestoreWriteStateEngineMapReverseDeltaTest extends AbstractStateEngineTest {
    ...
    public void test() throws IOException {
        ...
        reader.applyDelta(new ByteArrayInputStream(deltaStream.toByteArray()));
        reader.applyDelta(new ByteArrayInputStream(reverseDeltaStream.toByteArray()));
    ...
    private void assertMapContains(int mapOrdinal, int keyOrdinal, int valueOrdinal, int hashCode) {
        ...
        assertEquals(valueOrdinal, actualValueOrdinal);
    }

...
public class HollowObjectMapperTest extends AbstractStateEngineTest {
    ...
    public void testBasic() throws IOException {
        ...
        assertEquals("{\"a1\": \"two\",\"a2\": 2,\"b\": {\"b1\": 20,\"b2\": 20000000,\"b3\": 2.2,\"b4\": \"two\",\"b5\": [2, 2, 2]},\"cList\": []}",
    ...
    public void testNullElements() {
        ...
        try {
            ...
            fail("NullPointerException not thrown from List containing null elements");
        } catch (NullPointerException e) {
            String m = e.getMessage();
            assertNotNull(m);
            assertTrue(m.contains("Lists"));
        }

        // Sets cannot contain null elements
        try {
            mapper.add(new TypeWithSet("a", null, "c"));
            fail("NullPointerException not thrown from Set containing null elements");
        } catch (NullPointerException e) {
            String m = e.getMessage();
            assertNotNull(m);
            assertTrue(m.contains("Sets"));
        }

        // Maps cannot contain null keys
        try {
            mapper.add(new TypeWithMap("a", "a", null, "b", "c", "c"));
            fail("NullPointerException not thrown from Map containing null keys");
        } catch (NullPointerException e) {
            String m = e.getMessage();
            assertNotNull(m);
            assertTrue(m.contains("Maps"));
        ...
        try {
            ...
            fail("NullPointerException not thrown from Map containing null values");
        } catch (NullPointerException e) {
            String m = e.getMessage();
            assertNotNull(m);
            assertTrue(m.contains("Maps"));
    ...
    public void testEnumAndInlineClass() throws IOException {
        ...
        assertEquals("TWO", obj.getString("_name"));

        GenericHollowObject subObj = obj.getObject("testClass");

        assertEquals(2, subObj.getInt("val1"));
        assertEquals(3, subObj.getInt("val2"));
    }
    ...
    public void testDate() throws IOException {
        ...
        assertEquals(time, obj.getLong("value"));
    }
    ...
    public void testTransient() throws IOException {
        ...
        assertTrue(schemeText.contains("notTransient"));
        assertFalse(schemeText.contains("transientKeyword"));
        assertFalse(schemeText.contains("annotatedTransient"));
    }
    ...
    public void testMappingClassWithTransientArray() throws IOException {
        ...
        String schemeText = baos.toString();
        assertTrue(schemeText.contains("TestClassContainingTransientArray"));
        assertFalse(schemeText.contains("int[]"));
        assertFalse(schemeText.contains("intArray"));
    }
    ...
    public void testMappingClassWithHollowTransientArray() throws IOException {
        ...
        String schemeText = baos.toString();
        assertTrue(schemeText.contains("TestClassContainingHollowTransientArray"));
        assertFalse(schemeText.contains("int[]"));
        assertFalse(schemeText.contains("intArray"));
    }
    ...
    public void testAssignedOrdinal() {
        ...
        mapper.add(o);
        assertNotEquals(HollowConstants.ORDINAL_NONE, o.__assigned_ordinal);
    }
    ...
    public void testPreassignedOrdinal() {
        ...
        mapper.add(o);
        assertNotEquals(1, o.__assigned_ordinal);
    }
    ...
    public void testIntAssignedOrdinal() {
        ...
        mapper.add(o);
        assertEquals(HollowConstants.ORDINAL_NONE, o.__assigned_ordinal);
    }
    ...
    public void testIntPreassignedOrdinal() {
        ...
        assertEquals(1, o.__assigned_ordinal);
    }
    ...
    protected void assertExpectedFailureMappingType(Class<?> clazz, String fieldName) {
        ...
        try {
            ...
            assertTrue(String.format("missing expected fieldname %s in the message, was %s", expected, e.getMessage()), e.getMessage().contains(expected));
        }
    }
    ...
    protected void assertExpectedFailureMappingInterfaceType(Class<?> clazz, Class<?> interfaceClazz) {
        ...
        try {
            ...
            assertTrue(String.format("trying to generate schema based on interface %s, was %s", interfaceClazz.getSimpleName(), e.getMessage()), e.getMessage().contains(expected));
        }
    }
    ...
    protected void assertExpectedFailureMappingArraysType(Class<?> clazz, Class<?> arrayClass) {
        ...
        try {
            ...
            assertTrue(String.format("trying to generate schema based on array %s, was %s", arrayClass.getSimpleName(), e.getMessage()), e.getMessage().contains(expected));
        }
    }
